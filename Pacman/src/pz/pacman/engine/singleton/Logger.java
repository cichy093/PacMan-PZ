...
public class Logger {
	...
	protected void logInitialInformation() {
		...
		String initInfo = "[ INIT ] -------- LOGGER STARTED, DATE: "+ date +"--------";
		this.log(initInfo);
	}
	...
	public void log(String text) {
		try {
			...
			PopupWindow.show("Log file problem", "Cannot append data to log file - file not found:\n"+ this.filename);
		}
	}
	...
	private String generateName() {
		...
		Date date = new Date();
		return "log_Pacman_"+ dateFormat.format(date) +".log";
	}
